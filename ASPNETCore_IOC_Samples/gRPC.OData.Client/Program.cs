...
string baseUri = "https://localhost:7216";

Console.ReadLine();
#region Szenario for
GrpcBookstoreClient gRPCbookStoreShowCase = new GrpcBookstoreClient(baseUri);
await gRPCbookStoreShowCase.ListShelves();
await gRPCbookStoreShowCase.ListBooks(2);

ODataBookstoreClient oDataBookStoreShowCase = new ODataBookstoreClient(baseUri);
await oDataBookStoreShowCase.ListShelves();
await oDataBookStoreShowCase.ListBooks(2);
#endregion
